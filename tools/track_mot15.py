...
def main(exp, args, num_gpu):
    ...
    *_, summary = evaluator.evaluate(
    ...
    if args.test:
        logger.info("Test mode: tracking results saved to {}".format(results_folder))
        logger.info("Submit these .txt files to https://motchallenge.net/ for official evaluation.")
        return
